...
public class PaymentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String pp_MerchantID = "ENTER_MerchantID";
        String pp_Password = "ENTER_Password";
        String IntegritySalt = "ENTER_IntegritySalt";
        ...
        System.out.println("DateFn: postData : " +postData);
            ...
            if (url.equals(paymentReturnUrl)) {
                ...
                for (String pair : values) {
                    ...
                    if (nameValue.length == 2) {
                        System.out.println("DateFn: Name:" + nameValue[0] + " value:" + nameValue[1]);
